...
def main():
    ...
    if Merek == 'Honda':
        ...
        Tahun_honda = st.selectbox('Choose year of assembly accordingly: ', list(range(2000,2020)))
        ...
        Tahun_suzuki = st.selectbox('Choose year of assembly accordingly: ', list(range(2000,2024)))
        ...
        Tahun_yamaha = st.selectbox('Choose year of assembly accordingly: ', list(range(2000,2020)))
